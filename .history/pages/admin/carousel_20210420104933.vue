  ...
  <section id="news">
    <v-container>
      ...
      <v-switch
        ...
        :label="`Is this a type of service: ${service}`"
      ></v-switch>
      <v-row>
        <v-col>
          <h3>Carousel</h3>
        ...
        <v-col v-if="serviceSwitch" cols="6">
          <h3>Services</h3>
      ...
      <v-row class="pt-2">
        ...
        <v-col cols="12">
          <v-btn class="mt-5" color="primary" @click="submitForm"
            >Add Post</v-btn
          >
        </v-col>
      </v-row>
    ...
    addPost() {
      ...
      postsCol
        .add({
          ...
          display_services: this.serviceSwitch,
          createdOn: new Date(),
        })
        .then(() => {
          this.reset()
