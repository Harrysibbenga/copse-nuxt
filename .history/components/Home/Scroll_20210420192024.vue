<template>
  <div>
    <v-btn icon @click.prevent="slidePrev"><v-icon>mdi-star</v-icon></v-btn>
    <input v-model="updateCarousel" type="number" min="0" max="5" />
    <v-btn @click.prevent="slideNext"><v-icon>mdi-star</v-icon></v-btn>
    <hooper
      style="height: 1300px"
